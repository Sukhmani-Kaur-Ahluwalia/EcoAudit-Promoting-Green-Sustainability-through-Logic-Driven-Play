...
public class QuizPage extends JFrame {
    ...
    void loadQuestion() {
        if (index < questions.length) {
            ...
            questionLabel.setText(questions[index].question);
            ...
            for (int i = 0; i < 4; i++) {
                ...
                optionBtns[i].setText(questions[index].options[shuffledIndex]);

                int score = questions[index].scores[shuffledIndex];
