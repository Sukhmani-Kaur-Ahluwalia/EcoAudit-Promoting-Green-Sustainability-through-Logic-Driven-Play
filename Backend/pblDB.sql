...
(1, "How's your morning started today?",
 'Had normal chatter 👥', 6,
 'Blasted loud music 🔥', 0,
 'Practiced yoga with chill vibes 🧘', 10,
 'Listened to loud music 🎧', 3,
 'C'),

(2, "What's your go-to drink?",
 'Plastic bottled soda 🥤', 0,
 'Water in a reusable bottle 💧', 10,
 'Coffee in a disposable cup ☕', 3,
 'Fresh juice with some packaging 🍹', 6,
 'B'),
...
(4, "What's your shopping style?",
 'Bought stuff with tons of plastic 🛍', 0,
 'Opted for reusable bags 🛍️', 6,
 'Shopped local, minimal packaging 🌿', 10,
 'Grabbed some single-use items 🤷', 3,
 'C'),

(5, "How's your energy consumption?",
 'Used energy-efficient bulbs 💡', 6,
 'Switched to solar 🌞', 10,
 'Sometimes turn off lights 🔌', 3,
 'Left lights on all day 🔌', 0,
 'B'),
